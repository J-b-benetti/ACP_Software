...
print("La matrice de corrélation (après mise à l'échelle) vaut: \n", correlation_matrix, "\n")
...
#print("Les valeurs propres de la matrice de corrélation (après mise à l'échelle) sont: \n", eigVals_after_scaled, "\n")
print("Les vecteurs propres de la matrice de corrélation (après mise à l'échelle) sont: \n", eigVects_after_scaled, "\n")
